    ...
    request({
      url: `http://ws.audioscrobbler.com/2.0/?method=artist.getinfo&artist=${encodeURIComponent(artistName)}&api_key=${key}&format=json&limit=100`,
          ...
          if (error) {
            reject('Cannot connect to LastFM API');
            console.log(error);
          }else if (body.error == 6) {
            reject('Artist not Found')
          } else {
            artistObj = {}
            artistObj.artist = body.artist.name
            if (body.artist.image[4]['#text'] == ''){
              artistObj.image = 'data:image/jpeg;base64,'
            }else {
              artistObj.image = body.artist.image[4]['#text']
            }
            artistObj.bio = body.artist.bio.summary
            artistObj.time = body.artist.bio.published
            artistObj.similar = []
            for (var i =0; i<body.artist.similar.artist.length;i++) {
              var smallObj = {}
              smallObj.artist = body.artist.similar.artist[i].name
              if (body.artist.similar.artist[i].image[4]['#text'] == ''){
                smallObj.image = 'data:image/jpeg;base64,'
              }else {
                smallObj.image = body.artist.similar.artist[i].image[4]['#text']
              }
              artistObj.similar.push(smallObj)
            }
            resolve(artistObj)
          }
      })
